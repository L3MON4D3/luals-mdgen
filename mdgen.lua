...
parser:option("-m --mode", "A string. Denotes a certain mode to operate in. The code that generates markdown receives this string, and can change behaviour based on it.")
local args = parser:parse()

-- some global arguments.
Templatefile = vim.fs.normalize(vim.fs.abspath(args.input))
Outfile = vim.fs.normalize(vim.fs.abspath(args.output))
JSONFile = vim.fs.normalize(vim.fs.abspath(args.doc))
Mode = args.mode
